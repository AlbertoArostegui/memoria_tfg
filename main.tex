...
\newcommand{\titulo}{ChatGPT-RAG para una mejor interacción con JIRA}
...
\newpage
\input{resumen} % Incluimos el resumen trilingüe
...
\input{abreviaturas}
\include{1. Introduccion/introduccion.tex}
\include{2. Contexto/contexto}
\include{3. Planificación/planificación}
\include{4. Tecnologías/tecnologías.tex}
\include{diseño/diseño.tex}
\include{implementacion/implementacion.tex}
\include{pruebas/pruebas.tex}
\include{conclusiones/conclusiones.tex}

\include{anexo/anexo.tex}
